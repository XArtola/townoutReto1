...
<div class="row mt-2">
	...
	<div class="col-lg-5 col-sm-11 mx-auto border rounded border-secondary">
		<form action="{{route('circuit.update',['id'=>$circuit->id])}}" id="inputs" method="POST" enctype="multipart/form-data">
			...
			<div class="form-group">
				<label class="col-form-label col-form-label-lg">Descripción del circuito</label>
			...
			<div class="form-group">
				<label class="col-form-label col-form-label-lg">Imagen</label>
			...
			<div class="form-group">
				<label class="col-form-label col-form-label-lg">Dificultad</label>
			...
			<div class="form-group">
				<label class="col-form-label col-form-label-lg">Duración</label>
			...
			<div class="form-group text-center">
				<button type="button" class="btn btn-primary" id="circuit_edit">Guardar cambios</button>
			</div>
