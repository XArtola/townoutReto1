...
<body>
    ...
    <nav>
        ...
        <ul>
            @guest
            <li>
                <button type="button" data-toggle="modal" data-target="#registerModal">@lang('main.sign-up')</button>
            </li>
            <li class="nav-item">
...
<div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="registerModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">@lang('main.sign-in')</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
