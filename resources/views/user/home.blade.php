...
<div id="all_circuits" class="p-1">
	...
	<div class="row bg-warning my-4">
		<h1 class="text-light text-uppercase lead col-12 font-weight-bold p-2 mx-4">@lang('user.dispo_circuits')</h1>
...
<div id="my_circuits" class="p-1">
	...
	<div class="row bg-info my-4">
		<h1 class="text-light text-uppercase lead col-12 font-weight-bold p-2 mx-4">@lang('user.my_circuits')</h1>
